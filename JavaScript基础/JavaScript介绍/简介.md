...
- [1. 简介](#1-简介)
    - [1.1. JavaScript 起源](#11-javascript-起源)
    - [1.2. JavaScript 实现](#12-javascript-实现)
        - [1.2.1. 核心（ECMAScript）](#121-核心ecmascript)
        - [1.2.2. ECMAScript 历史](#122-ecmascript-历史)
        - [1.2.3. 文档对象模型（DOM）](#123-文档对象模型dom)
            - [1.2.3.1. DOM1 级：](#1231-dom1-级)
            - [1.2.3.2. DOM2 级：](#1232-dom2-级)
            - [1.2.3.3. DOM3 级：](#1233-dom3-级)
        - [1.2.4. 浏览器对象模型（BOM）](#124-浏览器对象模型bom)
- [2. 小结](#2-小结)
